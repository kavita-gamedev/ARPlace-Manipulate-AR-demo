...
public class Reporter : MonoBehaviour
{
	...
	void drawToolBar()
	{
		...
		toolBarRect.x = 0f;
		toolBarRect.y = 0f;
		toolBarRect.y = Screen.height - Screen.safeArea.height;
	...
	public void OnGUIDraw()
	{
		...
		logsRect.x = 0f;
		logsRect.y = toolBarRect.height + toolBarRect.y;
		...
		stackRect.y = Screen.height * 0.75f + toolBarRect.height;
		stackRect.width = Screen.width;
		stackRect.height = Screen.safeArea.height * 0.25f - size.y - toolBarRect.height;
